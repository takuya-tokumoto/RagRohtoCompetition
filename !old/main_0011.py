...
def rag_implementation(question: str) -> str:
    ...
    def create_reanswer(question: str, answer: str) -> str:
        ...
        ルール:
        1. 回答は1文または2文以内で簡潔に記述してください。ただし、回答が曖昧にならない場合に限ります。
        2. 回答に必要な補足情報や文脈は追加してください。
        3. 質問に対する具体的で明確な回答を優先してください。
        4. 出力する回答文は日本語で回答してください。
        ...
        result = simplify_chain.invoke({"question": question, "answer": answer})
